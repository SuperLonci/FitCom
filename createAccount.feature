Feature: Create Account
    ...
    Scenario: Invalid Name
        Given The app is opend and I scanned the right QR-Code
         When I enter "" into the input field 
         Then Message toast with text "Enter your name" is displayed

    Scenario: Invalid Email
        Given The app is opend and I scanned the right QR-Code and typed my name into the input field
         When I enter "thatsNotAnEmail" into the email input field
         Then Message toast with text "Invalid Email adress!"
